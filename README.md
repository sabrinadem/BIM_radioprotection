# Simulateur d'atténuation par rayons X pour composites PEEK/charge radio-opaque
...
où :
- `μ/ρ` est le **coefficient d'atténuation massique** (cm²/g), qui dépend de l'énergie du photon et de la composition chimique du matériau
